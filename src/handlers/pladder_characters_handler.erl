...
%%%-------------------------------------------------------------------
-module(pladder_characters_handler).
...
trails() ->
    ...
    #{
        name => <<"page_size">>,
        in => query,
        description => <<"Number of character per page. "
    ...
    #{
        name => <<"character_name">>,
        in => query,
        description => <<"Find character(s) based on charater name">>,
        required => false,
        type => string
    },
    Account =
    #{
        name => <<"account_name">>,
        in => query,
        description => <<"Find character(s) based on account name">>,
        required => false,
        type => string
    },
    Class =
    #{
        name => <<"class">>,
        in => query,
        description => <<"Find character(s) based on class">>,
        required => false,
        type => string
    },
    Ladder =
    #{
        name => <<"ladder">>,
        in => query,
        description => <<"Find character(s) based on ladder">>,
        required => false,
        type => string
    },
    Sort =
    #{
        name => <<"sort_by">>,
        in => query,
        description => <<"Sort result by rank, level, name, "
                         "exp, dead, online, class. Default: rank">>,
        required => false,
        type => string
    },
    SortOrder =
    #{
        name => <<"sort_order">>,
        in => query,
        description => <<"Sort in asc or desc order. Default: asc">>,
        required => false,
        type => string
    },
    Metadata =
...
handle_get(Req, State) ->
    ...
    Sort = pladder_handler_utils:qs_sort(Conditions, rank),
