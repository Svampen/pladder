...
%%%
%%% @end
%%% Created : 08. Jul 2017 17:49
%%%-------------------------------------------------------------------
-module(pladder_experiences_handler).
...
trails() ->
    ...
    #{
        name => <<"page_size">>,
        in => query,
        description => <<"Number of experience points per page. "
    ...
    #{
        name => <<"character_id">>,
        in => query,
        description => <<"Find experience point(s) by id">>,
        required => false,
        type => string
    },
    Sort =
    #{
        name => <<"sort_by">>,
        in => query,
        description => <<"Sort result by date, exp Default: exp">>,
        required => false,
        type => string
    },
    SortOrder =
    ...
    #{
        get => #{
            tags => ["experiences"],
            description => "Returns experience data points",
            produces => ["application/json"],
            parameters => [Id, Sort, SortOrder, PageSize, Page, Filter]
        }
    },
    Path = "/experiences",
    Opts = #{ path => Path, model => experiences, verbose => true
    },
...
handle_get(Req, State) ->
    ...
    Sort = pladder_handler_utils:qs_sort(Conditions, experience),
